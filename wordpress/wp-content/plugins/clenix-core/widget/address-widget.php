...
class ClenixTheme_Address_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'clenix_address', // Base ID
            esc_html__( 'Clenix : Address (for footer)', 'clenix-core' ), // Name
            array( 'description' => esc_html__( 'Address Widget', 'clenix-core' ) ) // Args
            );
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'   		=> esc_html__( 'Corporate Office' , 'clenix-core' ),
			'description'	=> '',
			'address'		=> '',
			'phone'   		=> '',
			'email'   		=> '',
