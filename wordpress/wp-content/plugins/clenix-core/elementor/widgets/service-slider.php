...
class Service_Slider extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Service Slider', 'clenix-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'slider' => esc_html__( 'Service Slider', 'clenix-core' ),
					'grid' => esc_html__( 'Service Grid', 'clenix-core' ),
				),
				'default' => 'slider',
			),
			array (
			...
			array (
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .service-slider-default .rtin-item .rtin-title' => 'color: {{VALUE}}',
					'{{WRAPPER}} .service-slider-default .rtin-item .rtin-title a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				'id'      => 'item_title_color_hover',
				'label'   => esc_html__( 'Item Title Hover Color', 'clenix-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-slider-default .rtin-item .rtin-title a:hover' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-slider-default .rtin-item .rtin-content p' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-slider .rtin-icon span i:before' => 'color: {{VALUE}}',
					'{{WRAPPER}} .service-slider .rtin-icon span i' => 'color: {{VALUE}}',
				),
			),			
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .service-slider .rtin-icon span' => 'background-color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				'id'      => 'icon_bg_color_hover',
				'label'   => esc_html__( 'Icon Background Hover Color', 'clenix-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-slider .rtin-item:hover span' => 'background-color: {{VALUE}}',
				),
			),			
			array(
				'mode' => 'section_end',
