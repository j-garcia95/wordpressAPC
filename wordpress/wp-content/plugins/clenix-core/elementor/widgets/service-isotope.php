...
class Service_Isotope extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Service Isotope', 'clenix-core' );
		$this->rt_base = 'rt-service-isotope';
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Isotope layout 1', 'clenix-core' ),
					'layout2' => esc_html__( 'Isotope layout 2', 'clenix-core' ),
				),
				'default' => 'layout1',
			),
			...
			array (
				...
				'id'      => 'category_list',
				'label'   => esc_html__( 'Add as many Categories as you want', 'clenix-core' ),
				'fields'  => array(
					array(
						'type'    => Controls_Manager::SELECT2,
						'name'    => 'cat_multi_box',
			...
			array (
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .service-default .rtin-item .rtin-content h3 a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-default .rtin-item:hover .rtin-content h3 a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .service-default .rtin-item .rtin-content p' => 'color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'all_button',
				'label'   => esc_html__( 'Show All Button', 'clenix-core' ),
				'options' => array(
			...
			array (
				...
				'default' => esc_html__( 'All Services', 'clenix-core' ),
			),
			array (
				'type'    => Controls_Manager::TEXT,
				'id'      => 'see_button_link',
	...
	protected function render() {
		...
		switch ( $data['layout'] ) {
			case 'layout2':
			$template = 'service-isotope-2';
			break;
			default:
			$template = 'service-isotope-1';
			break;
		}
