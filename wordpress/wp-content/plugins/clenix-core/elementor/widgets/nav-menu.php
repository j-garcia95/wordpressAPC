...
class Nav_Menu extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = __( 'Navigation Manu', 'clenix-core' );
	...
	public function rt_fields(){
		...
		$menu_items      = array();
		$menu_items['0'] = __( '---Select---', 'clenix-pro' );
		...
		$fields = array(
			array(
				'mode'    => 'section_start',
				'id'      => 'sec_general',
				'label'   => __( 'General', 'clenix-core' ),
			),
			array(
				'type'    => Controls_Manager::TEXT,
				'id'      => 'title',
				'label'   => __( 'Title', 'clenix-core' ),
				'default' => 'Title here ....',
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'menu',
				'label'   => __( 'Navigation Manu', 'clenix-core' ),
				'options' => $menu_items,
				'default' => '0',
			),
			array(
