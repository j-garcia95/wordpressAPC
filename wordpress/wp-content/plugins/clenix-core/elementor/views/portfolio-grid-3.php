		...
		<div class="<?php echo esc_attr( $col_class ) ?> rt-grid-item">
			<div class="rtin-item">
				...
				<div class="rtin-content">
					<h3 style="<?php echo wp_kses_post( $title_css ); ?>"><a href="<?php the_permalink(); ?>"><?php echo esc_html( $portfolio_title );?><i class="fa fa-chevron-right" aria-hidden="true"></i></a></h3>
				</div>
			</div>
		</div>
		<?php } ?>
