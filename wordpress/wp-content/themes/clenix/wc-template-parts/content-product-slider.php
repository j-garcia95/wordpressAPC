...
elseif ( ClenixTheme::$layout == 'full-width' ) {
	$responsive = array(
		'0'    => array( 'items' => 1 ),
		'480'  => array( 'items' => 2 ),
		'768'  => array( 'items' => 3 ),
...
<div class="owl-wrap rt-woo-nav related products <?php echo esc_attr( $wrapper_class );?>">
	<div class="section-title">
		<div class="sec-title center">
			<?php if ( ClenixTheme::$options['wc_related_title'] ) { ?>
				<h2 class="rtin-title"><?php echo wp_kses( ClenixTheme::$options['wc_related_title'] , 'alltext_allow' );?></h2>
			<?php } ?>
			<?php if ( ClenixTheme::$options['wc_related_subtitle'] ) { ?>
			<p><?php echo wp_kses( ClenixTheme::$options['wc_related_subtitle'] , 'alltext_allow' );?></p>
			<?php } ?>
		</div>
