...
$clenix_has_entry_meta  = ( ClenixTheme::$options['post_author_name'] || ClenixTheme::$options['post_date'] || ClenixTheme::$options['post_comment_num'] || ClenixTheme::$options['post_cats'] || ( ClenixTheme::$options['post_length'] && function_exists( 'clenix_reading_time' ) ) || ( ClenixTheme::$options['post_view'] && function_exists( 'clenix_views' ) ) ) ? true : false;
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-header">
		<?php if ( ClenixTheme::$options['post_featured_image'] == true ) { ?>
			<?php if ( has_post_thumbnail() ) { ?>
				<div class="entry-thumbnail-area"><?php the_post_thumbnail( 'clenix-size1' , ['class' => 'img-responsive'] ); ?></div>
			<?php } ?>
		<?php } ?>
	...
	<?php if ( ClenixTheme::$options['post_author_bio'] == '1' ) { ?>
		<?php if ( !empty ( $clenix_author_bio ) ) { ?>
