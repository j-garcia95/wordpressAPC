<?php
$clenix_footer_column = ClenixTheme::$options['footer_column_2'];
...
<?php if ( ClenixTheme::$footer_area == 1 || ClenixTheme::$footer_area == 'on' ) { ?>
	...
	<div class="footer-top-area">
		<div class="container">
			...
			<?php if ( is_active_sidebar( 'newsletter_widget' ) || is_active_sidebar( 'followus_widget' ) ) { ?>
			<div class="footer-middle-area">
				<div class="row">
					<div class="col-lg-5 col-12"><div class="newsletter"><?php dynamic_sidebar( 'newsletter_widget' ); ?></div></div>
					<div class="col-lg-7 col-12"><div class="followus"><?php dynamic_sidebar( 'followus_widget' ); ?></div></div>
				</div>
			</div>
			<?php } ?>
		</div>
