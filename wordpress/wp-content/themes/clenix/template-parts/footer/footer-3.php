			...
			<div class="container">
				<div class="footer-top-wrap">
					<div class="footer-left">
						<div class="footer-logo"><a class="dark-logo" href="<?php echo esc_url( home_url( '/' ) );?>"><img src="<?php echo esc_url( $clenix_light_logo );?>" alt="<?php esc_attr( bloginfo( 'name' ) ) ;?>"></a></div>
					</div>
