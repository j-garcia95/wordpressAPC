...
$clenix_has_entry_meta  = ( ClenixTheme::$options['blog_author_name'] || ClenixTheme::$options['blog_cats'] || ClenixTheme::$options['blog_comment_num'] || ClenixTheme::$options['blog_view'] && function_exists( 'clenix_views' ) || ClenixTheme::$options['blog_length'] && function_exists( 'clenix_reading_time' ) ) ? true : false;
